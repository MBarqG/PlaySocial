...
<body>
    ...
    <div class="sidebar">
        <div class="shortcut-links">
            ...
            <a style="color: #dc3545;" href="/saves"><img src="{{ asset('images/save on.png') }}">
                <p>Saved videos</p>
            </a>
    ...
    <div class="container">
        <div class="list-container">
            @foreach ($videos as $video)
                ...
                @endphp
                <div class="vid-list">
                    <a href="/video/{{ $video->id }}"><img style="max-height: 300px" src="{{ $video->thumbnail }}"
                            class="thumbnail"></a>
                    <div class="flex-div">
                        <a href="{{ route('profile', ['id' => $videocreator->id]) }}"><img
                                style="max-height: 35px ; max-width: 35px"
                                src="{{ $videocreator->profile_picture }}"></a>
                        <div class="vid-info">
