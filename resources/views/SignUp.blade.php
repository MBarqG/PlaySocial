    ...
    <div class="centered-card p-10 max-w-lg mx-auto mt-24">
        <div class="card border-danger text-center">
            ...
            <form method="POST" action="/users" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    <label aria-placeholder="" for="password" class="inline-block text-red mb-4"> Password </label>
                    <input type="password" class="border border-danger rounded" name="password"
                        value="{{ old('password') }}" />
                    <p class="hint">&#x2022 Password must be 8 characters long minimum</p>
                    @error('Password')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-6">
                    ...
                    <input type="password" class="border border-danger rounded" name="password_confirmation"
                ...
                <div class="mb-6">
                    <button type="submit" class="btn btn-lg btn-outline-danger rounded py-2 px-4 hover:bg-black">Sign
                        Up</button>
                </div>
                <div class="mt-8">
                    <p>
