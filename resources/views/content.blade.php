        ...
        <div class="row">
            ...
            <div class="play-video">
                ...
                <div class="plublisher">
                    <a href="{{ route('profile', ['id' => $creator->id]) }}"><img
                            src="{{ asset($creator->profile_picture) }}"></a>
                    <div>
                        @php
                ...
                <div class="video-descripion">
                    ...
                    <form method="Post" action="{{ url($video->id . '/addcomment') }}">
                        ...
                        <div class="add-comment">
                            ...
                            <input autocomplete="off" type="text" placeholder="add comment here..."
                                name="comment_text">
                            <input type="text" class="hideinput" value="{{ $video->id }}" name="content_id">
                    ...
                    @foreach ($comments as $comment)
                        <div class="old-comments">
                            ...
                            <a href="{{ route('profile', ['id' => $user->id]) }}"><img
                                    src="{{ asset($user->profile_picture) }}"></a>
                            <div>
            ...
            <div class="right-sidebar">
                ...
                @foreach ($videoList as $Videoitem)
                    ...
                    <div class="side-video-list">
                        <a href="/video/{{ $Videoitem->id }}" class="small-thumbnail"><img
                                src="{{ asset($Videoitem->thumbnail) }}"></a>
