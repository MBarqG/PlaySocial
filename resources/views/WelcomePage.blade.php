...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#"><img id="logo-image" src="{{ asset('images/logo.png') }}" alt="PlaySocial"
                    width="112" height="21"></a>
    ...
    <div class="container-xl">
        ...
        <div class="d-grid gap-2 col-4">
            <button class="btn btn-primary btn-lg btn-danger" type="button" onclick="location.href='/Login'">Log
                in</button>
            <button class="btn btn-lg btn-outline-danger" type="button" onclick="location.href='/Signup'">Sign
                up</button>
        </div>
    </div>
    <br>
            ...
            <div class="col">
                <div class="card text-center custom-rounded h-100">
                    <div class="card-body text-white bg-danger custom-rounded-top">
                        ...
                        <hr>
                        <p class="card-text">5 minutes max video time limit.<br>100 videos max upload.<br>70 to 30 spilt
                            in monetization between creator and platform.</p>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="5000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>providing a medium for users to share their videos and other forms of content with a wide
                            audience.</p>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>offer opportunities for content creators to monetize their work through advertising,
                            sponsorships, subscriptions, or crowdfunding.</p>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <p>facilitate collaboration between content creators, allowing them to work together on joint
                            projects, share resources, and build connections within the industry. </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 card-gap">
                <div class="card border-danger">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('images\MB LOGO.png') }}" class="img-fluid rounded-start"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Owner, Lead Developer and Designer for the platform <br> Major in
                                    Computer Science from An-Najah National University</p>
            ...
            <div class="col-md-6 card-gap">
                <div class="card border-danger">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ asset('images\instructor.jpg') }}" class="img-fluid rounded-start"
                                alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">CEO of Auxilium Technology and Project instructor <br> Computer
                                    Science Instructor at An-Najah National University</p>
                                <p class="card-text"><small class="text-muted">From: Nablus-Palestine</small></p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function updateLogoSource() {
            ...
            if (screenWidth < 900) {
                logoImage.src = "{{ asset('images/mainicon.png') }}";
                logoImage.width = "50";
                logoImage.height = "50";
            } else {
